...
granda-listo:
	cd aspell; make
	cd libreoffice; make
	sort -u aspell/aspell-listo.txt libreoffice/libreoffice-listo.txt libreoffice/libreoffice-aldonoj.txt > granda-listo.txt
...
esploro:
	wc -l aspell/aspell-listo.txt libreoffice/libreoffice-listo.txt libreoffice/libreoffice-aldonoj.txt granda-listo.txt
